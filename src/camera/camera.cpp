...
void Camera::processKeyboard(CameraMovement direction, float deltaTime) {
    ...
    switch (direction) {
        case CAM_FORWARD:  m_position += m_front * velocity; break;
        case CAM_BACKWARD: m_position -= m_front * velocity; break;
        case CAM_LEFT:     m_position -= m_right * velocity; break;
        case CAM_RIGHT:    m_position += m_right * velocity; break;
        case CAM_UP:       m_position += m_up * velocity; break;
        case CAM_DOWN:     m_position -= m_up * velocity; break;
    }
}
